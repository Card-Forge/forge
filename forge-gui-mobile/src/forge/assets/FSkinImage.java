...
public enum FSkinImage implements FSkinImageInterface {
    ...
    //Mana symbols
    MANA_COLORLESS (FSkinProp.IMG_MANA_COLORLESS),
    MANA_B         (FSkinProp.IMG_MANA_B),
    MANA_R         (FSkinProp.IMG_MANA_R),
    MANA_U         (FSkinProp.IMG_MANA_U),
    MANA_G         (FSkinProp.IMG_MANA_G),
    MANA_W         (FSkinProp.IMG_MANA_W),
    MANA_2B        (FSkinProp.IMG_MANA_2B),
    MANA_2G        (FSkinProp.IMG_MANA_2G),
    MANA_2R        (FSkinProp.IMG_MANA_2R),
    MANA_2U        (FSkinProp.IMG_MANA_2U),
    MANA_2W        (FSkinProp.IMG_MANA_2W),
    MANA_HYBRID_CB (FSkinProp.IMG_MANA_HYBRID_CB),
    MANA_HYBRID_CG (FSkinProp.IMG_MANA_HYBRID_CG),
    MANA_HYBRID_CR (FSkinProp.IMG_MANA_HYBRID_CR),
    MANA_HYBRID_CU (FSkinProp.IMG_MANA_HYBRID_CU),
    MANA_HYBRID_CW (FSkinProp.IMG_MANA_HYBRID_CW),
    MANA_HYBRID_BG (FSkinProp.IMG_MANA_HYBRID_BG),
    MANA_HYBRID_BR (FSkinProp.IMG_MANA_HYBRID_BR),
    MANA_HYBRID_GU (FSkinProp.IMG_MANA_HYBRID_GU),
    MANA_HYBRID_GW (FSkinProp.IMG_MANA_HYBRID_GW),
    MANA_HYBRID_RG (FSkinProp.IMG_MANA_HYBRID_RG),
    MANA_HYBRID_RW (FSkinProp.IMG_MANA_HYBRID_RW),
    MANA_HYBRID_UB (FSkinProp.IMG_MANA_HYBRID_UB),
    MANA_HYBRID_UR (FSkinProp.IMG_MANA_HYBRID_UR),
    MANA_HYBRID_WB (FSkinProp.IMG_MANA_HYBRID_WB),
    MANA_HYBRID_WU (FSkinProp.IMG_MANA_HYBRID_WU),
    MANA_PHRYX     (FSkinProp.IMG_MANA_PHRYX),
    MANA_PHRYX_U   (FSkinProp.IMG_MANA_PHRYX_U),
    MANA_PHRYX_W   (FSkinProp.IMG_MANA_PHRYX_W),
    MANA_PHRYX_R   (FSkinProp.IMG_MANA_PHRYX_R),
    MANA_PHRYX_G   (FSkinProp.IMG_MANA_PHRYX_G),
    MANA_PHRYX_B   (FSkinProp.IMG_MANA_PHRYX_B),
    MANA_PHRYX_BG   (FSkinProp.IMG_MANA_PHRYX_BG),
    MANA_PHRYX_BR   (FSkinProp.IMG_MANA_PHRYX_BR),
    MANA_PHRYX_GU   (FSkinProp.IMG_MANA_PHRYX_GU),
    MANA_PHRYX_GW   (FSkinProp.IMG_MANA_PHRYX_GW),
    MANA_PHRYX_RG   (FSkinProp.IMG_MANA_PHRYX_RG),
    MANA_PHRYX_RW   (FSkinProp.IMG_MANA_PHRYX_RW),
    MANA_PHRYX_UB   (FSkinProp.IMG_MANA_PHRYX_UB),
    MANA_PHRYX_UR   (FSkinProp.IMG_MANA_PHRYX_UR),
    MANA_PHRYX_WB   (FSkinProp.IMG_MANA_PHRYX_WB),
    MANA_PHRYX_WU   (FSkinProp.IMG_MANA_PHRYX_WU),
    ...
    MANA_5         (FSkinProp.IMG_MANA_5),
    MANA_6         (FSkinProp.IMG_MANA_6),
    MANA_7         (FSkinProp.IMG_MANA_7),
    MANA_8         (FSkinProp.IMG_MANA_8),
    MANA_9         (FSkinProp.IMG_MANA_9),
    MANA_10        (FSkinProp.IMG_MANA_10),
    MANA_11        (FSkinProp.IMG_MANA_11),
    MANA_12        (FSkinProp.IMG_MANA_12),
    MANA_13        (FSkinProp.IMG_MANA_13),
    MANA_14        (FSkinProp.IMG_MANA_14),
    MANA_15        (FSkinProp.IMG_MANA_15),
    MANA_16        (FSkinProp.IMG_MANA_16),
    MANA_17        (FSkinProp.IMG_MANA_17),
    MANA_18        (FSkinProp.IMG_MANA_18),
    MANA_19        (FSkinProp.IMG_MANA_19),
    MANA_20        (FSkinProp.IMG_MANA_20),
    MANA_X         (FSkinProp.IMG_MANA_X),
    MANA_Y         (FSkinProp.IMG_MANA_Y),
    MANA_Z         (FSkinProp.IMG_MANA_Z),
