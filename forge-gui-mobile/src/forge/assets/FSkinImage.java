...
public enum FSkinImage implements FImage {
    ...
    TROPHY_CASE_TOP  (FSkinProp.IMG_TROPHY_CASE_TOP, SourceFile.TROPHY_SHELF),
    TROPHY_SHELF     (FSkinProp.IMG_TROPHY_SHELF, SourceFile.TROPHY_SHELF),
    ...
    GAME_WIN_STREAK  (FSkinProp.IMG_GAME_WIN_STREAK, SourceFile.TROPHIES),
    MATCH_WIN_STREAK (FSkinProp.IMG_MATCH_WIN_STREAK, SourceFile.TROPHIES),
    TOTAL_GAME_WINS  (FSkinProp.IMG_TOTAL_GAME_WINS, SourceFile.TROPHIES),
    TOTAL_MATCH_WINS (FSkinProp.IMG_TOTAL_MATCH_WINS, SourceFile.TROPHIES),
    NEED_FOR_SPEED   (FSkinProp.IMG_NEED_FOR_SPEED, SourceFile.TROPHIES),
    OVERKILL         (FSkinProp.IMG_OVERKILL, SourceFile.TROPHIES),
    LIFE_TO_SPARE    (FSkinProp.IMG_LIFE_TO_SPARE, SourceFile.TROPHIES),
    HELLBENT         (FSkinProp.IMG_HELLBENT, SourceFile.TROPHIES),
    VANGUARD         (FSkinProp.IMG_VANGUARD, SourceFile.TROPHIES),
    MOMIR_BASIC      (FSkinProp.IMG_MOMIR_BASIC, SourceFile.TROPHIES),
    COMMANDER        (FSkinProp.IMG_COMMANDER, SourceFile.TROPHIES),
    PLANECHASE       (FSkinProp.IMG_PLANECHASE, SourceFile.TROPHIES),
    ARCHENEMY        (FSkinProp.IMG_ARCHENEMY, SourceFile.TROPHIES),
    POISONED         (FSkinProp.IMG_POISONED, SourceFile.TROPHIES),
    DECKED_OUT       (FSkinProp.IMG_DECKED_OUT, SourceFile.TROPHIES),
    BLACKJACK        (FSkinProp.IMG_BLACKJACK, SourceFile.TROPHIES),
    THE_FILIBUSTER   (FSkinProp.IMG_THE_FILIBUSTER, SourceFile.TROPHIES),
    THE_CLEAN_SLATE  (FSkinProp.IMG_THE_CLEAN_SLATE, SourceFile.TROPHIES),
    THE_LIBRARY_OF_CONGRESS (FSkinProp.IMG_THE_LIBRARY_OF_CONGRESS, SourceFile.TROPHIES),
    THE_CLIQUE       (FSkinProp.IMG_THE_CLIQUE, SourceFile.TROPHIES),
    THE_ACCIDENT     (FSkinProp.IMG_THE_ACCIDENT, SourceFile.TROPHIES),
    THE_TEAMWORK     (FSkinProp.IMG_THE_TEAMWORK, SourceFile.TROPHIES),
    THE_MACHINE      (FSkinProp.IMG_THE_MACHINE, SourceFile.TROPHIES),
    THE_ARMY         (FSkinProp.IMG_THE_ARMY, SourceFile.TROPHIES),
    THE_CATS_LIFE    (FSkinProp.IMG_THE_CATS_LIFE, SourceFile.TROPHIES),
    THE_TOWER        (FSkinProp.IMG_THE_TOWER, SourceFile.TROPHIES),
    THE_HOARD        (FSkinProp.IMG_THE_HOARD, SourceFile.TROPHIES),
    THE_INSANITY     (FSkinProp.IMG_THE_INSANITY, SourceFile.TROPHIES),
    THE_GARGANTUAN   (FSkinProp.IMG_THE_GARGANTUAN, SourceFile.TROPHIES),
    THE_LABYRINTH    (FSkinProp.IMG_THE_LABYRINTH, SourceFile.TROPHIES),
    THE_BONEYARD     (FSkinProp.IMG_THE_BONEYARD, SourceFile.TROPHIES),
    THE_EDGE         (FSkinProp.IMG_THE_EDGE, SourceFile.TROPHIES),
    ...
    public enum SourceFile {
        ...
        TROPHIES(ForgeConstants.TROPHIES_FILE),
        TROPHY_SHELF(ForgeConstants.TROPHY_SHELF_FILE);
