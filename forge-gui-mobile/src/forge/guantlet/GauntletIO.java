...
public class GauntletIO {
    ...
    public static File getGauntletFile(String name) {
        return new File(Constants.USER_GUANTLET_DIR, name + SUFFIX_DATA);
    }
    ...
    public static File[] getGauntletFilesUnlocked() {
        ...
        File folder = new File(Constants.USER_GUANTLET_DIR);
    ...
    public static File[] getGauntletFilesLocked() {
        ...
        File folder = new File(Constants.DEFAULT_GUANTLET_DIR);
        return folder.listFiles(filter);
    }
