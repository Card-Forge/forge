...
import forge.itemmanager.views.ItemColumnConfig.SortState;
...
public enum ColumnDef {
    ...
    SET("Set", "Set", 38, true, SortState.DESC, new ItemCellRenderer(),
            new Function<Entry<InventoryItem, Integer>, Comparable<?>>() {
                @Override
                public Comparable<?> apply(final Entry<InventoryItem, Integer> from) {
    ...
    DECK_QUANTITY("Quantity", "Quantity", 50, true, SortState.ASC, new ItemCellRenderer(),
            new Function<Entry<InventoryItem, Integer>, Comparable<?>>() {
                @Override
                public Comparable<?> apply(final Entry<InventoryItem, Integer> from) {
                    return from.getValue();
    ...
    DECK_EDITION("Set", "Set of oldest card in deck", 38, true, SortState.DESC, new ItemCellRenderer(),
            new Function<Entry<InventoryItem, Integer>, Comparable<?>>() {
                @Override
                public Comparable<?> apply(final Entry<InventoryItem, Integer> from) {
