...
public class ImageCache {
    ...
    // A card with a local image file takes two entries - the decoded original and the scaled
    // copy the panel paints - so 400 cannot hold one large zone view. Treat that long-standing
