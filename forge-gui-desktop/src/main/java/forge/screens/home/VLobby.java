...
public class VLobby implements ILobbyView {
    ...
    private final VariantCheckBox vntPauperCommander = new VariantCheckBox(GameType.PauperCommander);
    ...
    private final ImmutableList<VariantCheckBox> vntBoxes  =
            ImmutableList.of(vntVanguard, vntMomirBasic, vntMoJhoSto, vntCommander, vntOathbreaker, vntBrawl, vntTinyLeaders, vntPauperCommander, vntPlanechase, vntArchenemy, vntArchenemyRumble);
