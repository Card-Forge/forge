...
public enum VSubmenuPreferences implements IVSubmenu<CSubmenuPreferences> {
    ...
    private final JCheckBox cbSmartTokenArt = new OptionsCheckBox(localizer.getMessage("cbPreferEraMatchedTokenArt"));
    ...
    VSubmenuPreferences() {
        ...
        pnlPrefs.add(new NoteLabel(localizer.getMessage("nlPreferEraMatchedTokenArt")), descriptionConstraints);
