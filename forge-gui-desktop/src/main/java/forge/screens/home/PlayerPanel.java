...
public class PlayerPanel extends FPanel {
    ...
    private void updateVariantControlsVisibility() {
        ...
        final boolean archenemyVisibility = mayEdit && lobby.hasVariant(GameType.ArchenemyRumble) || (isArchenemyApplied && isArchenemy());
        ...
        scmDeckSelectorBtn.setVisible(archenemyVisibility);
        scmDeckEditor.setVisible(archenemyVisibility);
        scmLabel.setVisible(archenemyVisibility);
