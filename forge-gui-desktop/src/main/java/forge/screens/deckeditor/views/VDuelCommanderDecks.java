...
public enum VDuelCommanderDecks implements IVDoc<CDuelCommanderDecks> {
    ...
    private final DragTab tab = new DragTab(localizer.getMessage("lblDuelCommander"));
    ...
    public void populate() {
        CDuelCommanderDecks.SINGLETON_INSTANCE.refresh(); //ensure decks refreshed in case any deleted or added since last loaded
        String preferredDeck = DeckPreferences.getDuelCommanderDeck();
    ...
    public void setCDetailPicture(final CDetailPicture cDetailPicture) {
        ...
        this.lstDecks.setCaption(localizer.getMessage("lblDuelCommanderDecks"));
    }
}
