...
public class ConvergePredictionTest extends AITest {
    ...
    public void convergeSizesATokenSpellOnTheXPath() {
        // TokenAi only casts a token spell TOKEN_GENERATION_ABILITY_CHANCE of the time (80 on the
        // default profile), so without a fixed stream this asserts a coin flip - it is the
        // converge sizing under test, not whether the AI felt like casting
