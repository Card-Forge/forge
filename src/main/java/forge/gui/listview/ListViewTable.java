...
public final class ListViewTable<T extends InventoryItem> extends JTable {
    private ListViewTableModel<T> model;
     ...
     */
    public ListViewTable(final Class<T> type0) {
        this(false, type0);
    }
     ...
     */
    @SuppressWarnings("serial")
    public ListViewTable(final boolean forceUnique, final Class<T> genericType) {
        this.model = new ListViewTableModel<T>(this, genericType);
    ...
    public void setup(final ITableContainer view0, final List<TableColumnInfo<InventoryItem>> cols0) {
        ...
        this.model.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(final TableModelEvent ev) {
                SListViewUtil.setStats(ListViewTable.this.model.getCards(), view0);
            }
        });
    }
