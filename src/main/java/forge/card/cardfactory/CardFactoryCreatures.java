...
public class CardFactoryCreatures {
        ...
        final Command intoPlay = new Command() {
            ...
            public void execute() {
                ...
                if (card.getController().isHuman()) {
                    final List<Card> artifacts = CardLists.filter(AllZone.getHumanPlayer().getCardsIn(ZoneType.Battlefield), CardPredicates.Presets.ARTIFACTS);
                    ...
                    art = CardLists.filter(art, Presets.ARTIFACTS);
    ...
    private static void getCard_MasterOfTheWildHunt(final Card card, final String cardName) {
        ...
        class MasterOfTheWildHuntAbility extends AbilityActivated {
            ...
            @Override
            public boolean canPlayAI() {
                List<Card> wolves = CardLists.getType(AllZone.getComputerPlayer().getCardsIn(ZoneType.Battlefield), "Wolf");
    ...
    private static void getCard_SurturedGhoul(final Card card, final String cardName) {
        ...
        card.addSpellAbility(new SpellPermanent(card) {
            ...
            public boolean canPlayAI() {
                ...
                list = CardLists.filter(list, Presets.CREATURES);
                return 0 < list.size();
            }
        });
    }
