...
public class CardFactorySorceries {
    ...
    private final static SpellAbility getFireBall( final Card card ) {
        /*
        ...
        final SpellAbility spell = new Spell(card) {
            ...
            public void resolve() {
                ...
                if (this.getActivatingPlayer().isComputer()) {
                    final StringBuilder sb = new StringBuilder();
                    sb.append(card.getName()).append(" - Computer causes ");
        ...
        final Input input = new Input() {
            ...
            public void selectButtonOK() {
                final StringBuilder sb = new StringBuilder();
                sb.append(card.getName()).append(" deals X damage to ");
    ...
    public static void buildCard(final Card card, final String cardName) {
        ...
        } else if (cardName.equals("Fireball")) { card.addSpellAbility(getFireBall(card));
