...
public class Gui_HomeScreen {
    ...
    private void initialize() {
        ...
        
        {
            ...
            }
            {
                ...
                //cmdLAF.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
            ...
            {
                JLabel lblGraphs = new JLabel("<html><u>Deck Generation Settings</u></html>");
        ...
        gHS.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{lblBackground,
                                                                              cmdConstructed,
                                                                              cmdSealed,
                                                                              cmdDraft, 
                                                                              cmdQuest, 
    ...
    private void doGameModeSelect() {
        // simulate a radio button group, because JRadioButton wasn't transparent on Roll-over
        ...
        if (GameTypeSelected.equals(GameType.Constructed)) {
            if (HumanDeckSelected.equals("Generate Deck")) {
                ...
                if (rDeck != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "No decks available.", "Random Deck Name", JOptionPane.INFORMATION_MESSAGE);
                    return false;
                }
    ...
    private Deck chooseGeneratedDeck(String p) {
        Deck ret = null;
    ...
    private Deck chooseRandomDeck() {
        ...
        if (subDecks.size() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "Not enough decks to choose from.", "Random Deck Name", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void showDecks() {
        ...
        if (GameTypeSelected.equals(GameType.Constructed)) {
            ...
            if (PlayerSelected.equals("Human")) {
                ...
                for (Deck aDeck : allDecks) {
                    if (aDeck.getDeckType().equals(GameType.Sealed) && aDeck.getPlayerType().equals(PlayerType.COMPUTER))
                        DeckList.addElement(aDeck.getName());
                }                
            }
