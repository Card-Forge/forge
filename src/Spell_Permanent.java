public class Spell_Permanent extends Spell
{
	...
	public Spell_Permanent(Card sourceCard)
  {
    ...
    if(sourceCard.isCreature())
      setStackDescription(sourceCard.getName() +" - Creature " +sourceCard.getNetAttack() +" / " +sourceCard.getNetDefense());
    else
  ...
  {
    return super.canPlay() || (getSourceCard().getKeyword().contains("Flash") && !AllZone.GameAction.isCardInPlay(getSourceCard()));
  }
