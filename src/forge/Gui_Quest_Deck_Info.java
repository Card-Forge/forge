...
public class Gui_Quest_Deck_Info implements NewConstants {
    ...
    private static void buildDeckList() {
    	...
    	The list of opponent quest decks with their descriptions is no longer built in this method.
    	All future opponent quest decks descriptions should be added to:
