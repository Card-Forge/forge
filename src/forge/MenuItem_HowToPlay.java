...
public class MenuItem_HowToPlay extends JMenuItem implements NewConstants.LANG.HowTo {
	...
	private String getString() {
        ...
        s.append("Legendary Cards" + newLine);
        ...
        s.append("Hybrid Mana and Multicolored Cards" + newLine);
        ...
        s.append("There are three kinds of abilities: Activated, Triggered, and Static." + newLine);
        ...
        s.append("Keyword Abilities" + newLine);
        ...
        s.append("9.  First Strike and Double Strike:  Creatures with first strike deals their combat damage first.  Creatures with double strike deals their combat damage first, and then deals their combat damage a second time during the combat damage step."
                + newLine);
        s.append("10.  Flash:  You can play a creature with flash anytime that you can play an Instant." + newLine);
        s.append("11.  Landwalk:  Allows your creature to attack without being blocked if your opponent controls the appropriate land type."
                + newLine);
        s.append("12.  Lifelink:  With lifeline you gain life equal to the amount of damage dealt." + newLine);
        s.append("13.  Protection:  Can not be damaged, blocked or targeted by sources that match the protection type."
                + newLine);
        s.append("14.  Reach:  Creatures with reach can block flying creatures." + newLine);
        s.append("15.  Shroud:  Permanents with shroud can not be targeted by abilities or spells." + newLine);
