...
public class QuestMainPanel extends JPanel implements NewConstants{
    ...
    private void jbInit() throws Exception {
        ...
        this.add(rankLabel, null);
        this.add(jLabel1, null);
        this.add(difficultyLabel, null);
        this.add(winLostLabel, null);
        this.add(creditsLabel,null);
        jPanel2.add(jLabel5, null);
        this.add(infoButton, null);
        ...
        if ("Fantasy".equals(questData.getMode())) {
        	this.add(otherShopsButton, null);
        	this.add(lifeLabel,null);
        	this.add(questsButton, null);
        	this.add(petComboBox, null);
        ...
        this.add(cardShopButton, null);
        this.add(deckEditorButton, null);
        this.add(playGameButton, null);
