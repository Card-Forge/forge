...
//        addToDeckList("Lucifer 3", "hard", "W Sacrifice");
        ...
        addToDeckList("Magnum 1", "easy", "GU Sturdy Hatchling, Shorecrasher Mimic");
        addToDeckList("Magnum 2", "medium", "GU Sturdy Hatchling, Shorecrasher Mimic");
        addToDeckList("Magnum 3", "hard", "GU Sturdy Hatchling, Shorecrasher Mimic");
...
//        addToDeckList("Michael 3", "hard", "W Angels");
        ...
        addToDeckList("Mr Slate 2", "medium", "Don't Go in the Water deck, Merfolk");
        addToDeckList("Mr Slate 3", "hard", "Don't Go in the Water deck, Merfolk");
...
//        addToDeckList("Sabertooth 2", "medium", "G Smokestack");
        ...
        addToDeckList("Saruman 2", "medium", "BUR discard deck with Megrim, Liliana's Caress, Burning Inquiry ");
        addToDeckList("Saruman 3", "hard", "BUR discard deck with Megrim, Liliana's Caress, Burning Inquiry ");
        addToDeckList("Sauron 2", "medium", "BU Black Vise deck with Underworld Dreams, lots of card draw for both players");
        addToDeckList("Scooby Doo 3", "hard", "WR Giants Aggro deck with a few changelings");
        addToDeckList("Scotty 2", "medium", "WBG Pestilence deck with Castle, Penumbra Kavu/Spider/Wurm but no pro black");
        addToDeckList("Seabiscuit 1", "easy", "W Metalcraft deck with Ardent Recruit, Indomitable Archangel");
        addToDeckList("Seabiscuit 2", "medium", "W Metalcraft deck with Ardent Recruit, Indomitable Archangel");
        addToDeckList("Seabiscuit 3", "hard", "W Metalcraft deck with Ardent Recruit, Indomitable Archangel");
        addToDeckList("Secret Squirrel 3", "hard", "G Squirrel deck with Squirrel Mob, Deranged Hermit, Coat of Arms, Nut Collector");
//        addToDeckList("Sentinel 2", "medium", "WB Token");
//        addToDeckList("Sentinel 3", "hard", "WB Token");
//        addToDeckList("Shelob 1", "easy", "G Reach");
        addToDeckList("Sherlock Holmes 1", "easy", "Mono G deck with Baru, Fist of Krosa, land fetch, some buff cards");
        addToDeckList("Sherlock Holmes 2", "medium", "Mono G deck with Baru, Fist of Krosa, lots of good green creatures");
        addToDeckList("Sherlock Holmes 3", "hard", "Mono G deck with Baru, Fist of Krosa, lots of great green creatures");
        addToDeckList("Silver Surfer 3", "hard", "G beat down deck with many creatures, several pump spells");
        addToDeckList("Spiderman 2", "medium", "W weenie deck with WoG, Armageddon, Mass Calcify");
...
//        addToDeckList("Starfire 3", "hard", "Incarnations");
        ...
        addToDeckList("Storm 3", "hard", "WBURG Lifelink deck with Phyrexian Arena");
//        addToDeckList("Superboy 3", "hard", "Artifact Red");
        addToDeckList("Superman 1", "easy", "WBURG Slivers deck with Raise Dead, Breath of Life");
        addToDeckList("Superman 2", "medium", "WBURG Slivers deck with Zombify, Tribal Flames");
//        addToDeckList("Swamp Thing 1", "easy", "GB");
//        addToDeckList("Swamp Thing 2", "medium", "GB");
//        addToDeckList("Swamp Thing 3", "hard", "GB");
        
        addToDeckList("Tarzan 1", "easy", "WG deck with jungle creatures, pump spells");
        addToDeckList("Tarzan 2", "medium", "WG deck with Silverback Ape, jungle creatures, pump spells");
        addToDeckList("Terminator 3", "hard", "U deck with Master of Etherium, Control Magic, Memnarch, many artifacts");
...
//        addToDeckList("Thugs 3", "hard", "GW Strength in Numbers");
        addToDeckList("Totoro 2", "medium", "BUG deck with spirits and arcane spells");
        addToDeckList("Treebeard 1", "easy", "G Treefolk deck with Bosk Banneret, Dauntless Dourbark, Leaf-Crowned Elder");
        addToDeckList("Treebeard 2", "medium", "WBG Treefolk deck with Bosk Banneret, Dauntless Dourbark, Timber Protector, Leaf-Crowned Elder, Doran");
        addToDeckList("Treebeard 3", "hard", "WBG Treefolk deck with Bosk Banneret, Dauntless Dourbark, Timber Protector, Leaf-Crowned Elder, Doran");
        
        addToDeckList("Uncle Owen 3", "hard", "WBU deck with creature removal and control, Liliana Vess");
...
//        addToDeckList("White Knight 3", "hard", "Knights Standard");
        addToDeckList("Wilma Flintstone 1", "easy", "BG deck with Noxious Hatchling, Woodlurker Mimic");
        addToDeckList("Wilma Flintstone 2", "medium", "BG deck with Noxious Hatchling, Woodlurker Mimic");
        addToDeckList("Wilma Flintstone 3", "hard", "BG deck with Noxious Hatchling, Woodlurker Mimic");
        addToDeckList("Wolverine 3", "hard", "BG deck with Nightmare, Korlash, Heir to Blackblade, Kodama's Reach");
        addToDeckList("Wyatt Earp 1", "easy", "Mono W deck with Crovax, Ascendant Hero, Crusade, small to medium sized creatures.");
        addToDeckList("Wyatt Earp 2", "medium", "Mono W deck with Crovax, Ascendant Hero, Crusade, small to medium sized creatures.");
        addToDeckList("Wyatt Earp 3", "hard", "Mono W deck with Crovax, Ascendant Hero, Honor of the Pure, small to medium sized creatures.");
