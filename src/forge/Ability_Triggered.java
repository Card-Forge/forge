...
public class Ability_Triggered extends Ability implements Command {
	...
	public boolean canPlay(){return false;}//this is a triggerred ability: it cannot be "played"
	...
	public boolean equals(Object o)//TODO: triggers affecting other cards
	{
		...
		return tmp.getSourceCard().equals(getSourceCard()) &&
			tmp.trigger.equals(trigger) && tmp.todo.equals(todo) &&
