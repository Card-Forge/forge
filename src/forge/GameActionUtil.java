			...
			if(CardUtil.getColors(c).contains(Constant.Color.Blue)
				...
				for(int i = 0; i < list.size(); i++) {
					...
					ability2.setStackDescription(card.getName()
							+ " - "
							+ c.getController()
							+ " played a spell thatï¿½s both green and blue, it becomes 5/3 and gains trample until end of turn.");
					AllZone.Stack.add(ability2);
				}
			}//if
		}
			...
			if(CardUtil.getColors(c).contains(Constant.Color.Red)
				...
				for(int i = 0; i < list.size(); i++) {
					...
					ability2.setStackDescription(card.getName()
							+ " - "
							+ c.getController()
							+ " played a spell thatï¿½s both red and white, it becomes 4/2 and gains first strike until end of turn.");
					AllZone.Stack.add(ability2);
				}
			}//if
		}
			...
			if(CardUtil.getColors(c).contains(Constant.Color.Black)
				...
				for(int i = 0; i < list.size(); i++) {
					...
					ability2.setStackDescription(card.getName()
							+ " - "
							+ c.getController()
							+ " played a spell thatï¿½s both black and white, it becomes 4/4 and gains flying until end of turn.");
					AllZone.Stack.add(ability2);
				}
			}//if
		}
			...
			if(CardUtil.getColors(c).contains(Constant.Color.Blue)
				...
				for(int i = 0; i < list.size(); i++) {
					...
					ability2.setStackDescription(card.getName()
							+ " - "
							+ c.getController()
							+ " played a spell thatï¿½s both red and blue, it becomes 3/3 and is unblockable until end of turn.");
					AllZone.Stack.add(ability2);
				}
			}//if
		}
			...
			if(CardUtil.getColors(c).contains(Constant.Color.Black)
				...
				for(int i = 0; i < list.size(); i++) {
					...
					ability2.setStackDescription(card.getName()
							+ " - "
							+ c.getController()
							+ " played a spell thatï¿½s both green and black, it becomes 4/5 and gains wither until end of turn.");
					AllZone.Stack.add(ability2);
				}
			}//if
		}
