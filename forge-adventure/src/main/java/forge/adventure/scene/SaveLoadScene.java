...
public class SaveLoadScene extends Scene {
    ...
    Stage stage;
    Color defColor;
    private IntMap<TextButton> buttons=new IntMap<>();
    ...
    public boolean LoadSave()
    {
        ...
        {
            WorldSave.getCurrentSave().Load(currentSlot);
        }
        return true;
    }
    ...
    public void create() {
        ...
        previewImage.setSize(WorldSaveHeader.previewImageWidth,WorldSaveHeader.previewImageWidth/(IntendedWidth/(float)IntendedHeight));

        previewImage.setPosition(IntendedWidth-previewImage.getWidth(),IntendedHeight-previewImage.getHeight());
