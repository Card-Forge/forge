package forge.adventure.libgdxgui.screens.match;
...
import forge.adventure.libgdxgui.card.CardAvatarImage;
import forge.adventure.libgdxgui.card.GameEntityPicker;
import forge.deck.CardPool;
import forge.adventure.libgdxgui.deck.FSideboardDialog;
...
import forge.adventure.libgdxgui.screens.match.views.*;
import forge.adventure.libgdxgui.screens.match.views.VPhaseIndicator.PhaseLabel;
import forge.adventure.libgdxgui.screens.match.views.VPlayerPanel.InfoTab;
import forge.adventure.libgdxgui.screens.match.winlose.ViewWinLose;
