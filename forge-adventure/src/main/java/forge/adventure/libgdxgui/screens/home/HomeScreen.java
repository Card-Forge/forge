...
import forge.adventure.libgdxgui.screens.achievements.AchievementsScreen;
import forge.adventure.libgdxgui.screens.online.OnlineMenu.OnlineScreen;
import forge.adventure.libgdxgui.screens.planarconquest.ConquestMenu;
...
public class HomeScreen extends FScreen {
    ...
    private HomeScreen() {
        ...
        addButton(localizer.getMessage("lblNewGame"), new FEvent.FEventHandler() {
            @Override
        ...
        addButton(localizer.getMessage("lblLoadGame"), new FEvent.FEventHandler() {
            @Override
            public void handleEvent(FEvent e) {
                activeButtonIndex = 1;
                Forge.lastButtonIndex = activeButtonIndex;
        ...
        addButton(localizer.getMessage("lblPlayOnline"), new FEvent.FEventHandler() {
            @Override
            public void handleEvent(FEvent e) {
                activeButtonIndex = 2;
                Forge.lastButtonIndex = activeButtonIndex;
