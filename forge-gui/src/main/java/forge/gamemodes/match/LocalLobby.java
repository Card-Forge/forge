...
public final class LocalLobby extends GameLobby {
    ...
    public LocalLobby() {
        ...
        final LobbySlot slot0 = new LobbySlot(LobbySlotType.LOCAL, humanName, avatarIndices[0], sleeveIndices[0], 0,
                true, true, Collections.emptySet());
        addSlot(slot0);

        final LobbySlot slot1 = new LobbySlot(LobbySlotType.AI, null, avatarIndices[1], sleeveIndices[1], 1, false,
                true, Collections.emptySet());
        slot1.setAiEndpoint(FModel.getAiEndpoint());
        addSlot(slot1);
    }
