...
public abstract class GameLobby implements IHasGameType {
    ...
    public void applyVariant(final GameType variant) {
        ...
        case Commander:
            ...
            data.appliedVariants.remove(GameType.PauperCommander);
    ...
    public void removeVariant(final GameType variant) {
        ...
        if (variant == currentGameType) {
            ...
            } else if (hasVariant(GameType.PauperCommander)) {
                currentGameType = GameType.PauperCommander;
            } else {
    ...
    public Runnable startGame() {
        ...
        if (!variantTypes.isEmpty()) {
            ...
            isCommanderMatch = isBrawlMatch || isTinyLeadersMatch || isOathbreakerMatch || variantTypes.contains(GameType.Commander) || variantTypes.contains(GameType.PauperCommander);
            if (!isCommanderMatch) {
                            ...
                            isOathbreakerMatch ? GameType.Oathbreaker :
                                isTinyLeadersMatch ? GameType.TinyLeaders :
                                    isBrawlMatch ? GameType.Brawl :
                                        variantTypes.contains(GameType.PauperCommander) ? GameType.PauperCommander :
                                            GameType.Commander;
                    if (checkLegality) {
