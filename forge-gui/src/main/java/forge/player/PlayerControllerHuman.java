...
public class PlayerControllerHuman extends PlayerController implements IGameController {
    ...
    public SpellAbility getAbilityToPlay(final Card hostCard, final List<SpellAbility> abilities,
        ...
        if (triggerEvent != null && !hostCard.isInZone(ZoneType.Battlefield) && !hostCard.getOwner().equals(player) && !hostCard.getController().equals(player)
                && !Iterables.any(abilities, SpellAbilityPredicates.isActivator(player))) {
            return null;
        }
