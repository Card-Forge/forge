...
public enum FSkinProp {
    ...
    IMG_TROPHY_CASE_TOP   (new int[] {0, 0, 798, 38}, PropType.TROPHY_SHELF),
    IMG_TROPHY_SHELF      (new int[] {0, 38, 798, 257}, PropType.TROPHY_SHELF),
    ...
    IMG_GAME_WIN_STREAK   (new int[] {0, 185, 135, 185}, PropType.TROPHY),
    IMG_MATCH_WIN_STREAK  (new int[] {135, 185, 135, 185}, PropType.TROPHY),
    IMG_TOTAL_GAME_WINS   (new int[] {270, 185, 135, 185}, PropType.TROPHY),
    IMG_TOTAL_MATCH_WINS  (new int[] {405, 185, 135, 185}, PropType.TROPHY),
    IMG_NEED_FOR_SPEED    (new int[] {540, 185, 135, 185}, PropType.TROPHY),
    IMG_OVERKILL          (new int[] {675, 185, 135, 185}, PropType.TROPHY),
    IMG_LIFE_TO_SPARE     (new int[] {810, 185, 135, 185}, PropType.TROPHY),
    IMG_HELLBENT          (new int[] {945, 185, 135, 185}, PropType.TROPHY),
    IMG_VANGUARD          (new int[] {0, 370, 135, 185}, PropType.TROPHY),
    IMG_MOMIR_BASIC       (new int[] {135, 370, 135, 185}, PropType.TROPHY),
    IMG_COMMANDER         (new int[] {270, 370, 135, 185}, PropType.TROPHY),
    IMG_PLANECHASE        (new int[] {405, 370, 135, 185}, PropType.TROPHY),
    IMG_ARCHENEMY         (new int[] {540, 370, 135, 185}, PropType.TROPHY),
    IMG_POISONED          (new int[] {675, 370, 135, 185}, PropType.TROPHY),
    IMG_DECKED_OUT        (new int[] {810, 370, 135, 185}, PropType.TROPHY),
    IMG_BLACKJACK         (new int[] {945, 370, 135, 185}, PropType.TROPHY),
    IMG_THE_FILIBUSTER    (new int[] {0, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_CLEAN_SLATE   (new int[] {135, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_LIBRARY_OF_CONGRESS (new int[] {270, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_CLIQUE        (new int[] {405, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_ACCIDENT      (new int[] {540, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_TEAMWORK      (new int[] {675, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_MACHINE       (new int[] {810, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_ARMY          (new int[] {945, 555, 135, 185}, PropType.TROPHY),
    IMG_THE_CATS_LIFE     (new int[] {0, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_TOWER         (new int[] {135, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_HOARD         (new int[] {270, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_INSANITY      (new int[] {405, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_GARGANTUAN    (new int[] {540, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_LABYRINTH     (new int[] {675, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_BONEYARD      (new int[] {810, 740, 135, 185}, PropType.TROPHY),
    IMG_THE_EDGE          (new int[] {945, 740, 135, 185}, PropType.TROPHY),
