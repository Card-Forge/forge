...
public enum FSkinProp {
    ...
    IMG_MANA_HYBRID_CB (new int[] {166, 494, 80, 80}, PropType.MANAICONS),
    IMG_MANA_HYBRID_CG (new int[] {248, 494, 80, 80}, PropType.MANAICONS),
    IMG_MANA_HYBRID_CR (new int[] {330, 494, 80, 80}, PropType.MANAICONS),
    IMG_MANA_HYBRID_CU (new int[] {412, 494, 80, 80}, PropType.MANAICONS),
    IMG_MANA_HYBRID_CW (new int[] {166, 576, 80, 80}, PropType.MANAICONS),
