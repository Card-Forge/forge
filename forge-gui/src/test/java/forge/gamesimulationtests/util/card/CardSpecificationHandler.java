...
public class CardSpecificationHandler extends SpecificationHandler<Card, CardSpecification> {
	...
	private List<Card> getCardsToSearch( Game game, final CardSpecification cardSpecification ) {
	...
	private List<Card> getCardsToSearch( Game game, final PlayerSpecification relevantPlayer ) {
