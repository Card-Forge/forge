...
public class SpellAbilityRestriction extends SpellAbilityVariables {
    ...
    public final boolean checkZoneRestrictions(final Card c, final SpellAbility sa) {
        ...
        final boolean useRelaxedOwnershipForCardProperties = activator != null && activator.getGame() != null
                && activator.getGame().getRules().relaxesControllerOwnershipForCardProperties(cardZone);
        Card cp = c;
