...
public enum Keyword {
    ...
    FABRICATE("Fabricate", KeywordWithAmountAndType.class, false, "When this creature enters the battlefield, put {%1$d:+1/+1 counter} on it, or create {%1$d:1/1 colorless Servo artifact creature token}."),
