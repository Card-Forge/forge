...
public enum Keyword {
    ...
    AGGRESSIVE("Aggressive", SimpleKeyword.class, true, "During your turn, there is an additional combat phase after the first, and only creatures with aggressive may attack during it."),
    ...
    EQUIPMENT_SWAP("Equipment swap", KeywordWithCost.class, false, "%s: Exchange this Equipment with an Equipment card in your hand. If this Equipment was attached to a creature, attach the new Equipment to that creature."),
